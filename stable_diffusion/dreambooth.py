...
#   os.system('git remote add -f origin  "https://USER:{token}@huggingface.co/runwayml/stable-diffusion-v1-5"')
#   os.system("""git config core.sparsecheckout true""")
#   os.system("""echo -e "feature_extractor\nsafety_checker\nscheduler\ntext_encoder\ntokenizer\nunet\nmodel_index.json" > .git/info/sparse-checkout""")
#   os.system("""git pull origin main""")
#   if os.path.exists('/content/stable-diffusion-v1-5/unet/diffusion_pytorch_model.bin'):
#     os.system('git clone "https://USER:{token}@huggingface.co/stabilityai/sd-vae-ft-mse')
...
#       os.system("""mkdir -p $WORKSPACE'/Sessions'""")
#       time.sleep(1)
#     os.chdir("""$WORKSPACE'/Sessions'""")
#     os.system("""gdown --folder --remaining-ok -O $Session_Name  $Session_Link_optional""")
...
#     os.system("""mv *.ckpt $Session_Name.ckpt""")
#     os.chdir("""/content""")
#
#
...
#         os.system("""mkdir -p "$CLASS_DIR"""")
#       os.chdir("""$CLASS_DIR""")
#       os.system("""rm -r Women Men Mix""")
#       os.system("""wget -O Womenz 'https://github.com/TheLastBen/fast-stable-diffusion/raw/main/Dreambooth/Regularization/Women'""")
#       os.system("""wget -O Menz 'https://github.com/TheLastBen/fast-stable-diffusion/raw/main/Dreambooth/Regularization/Men'""")
#       os.system("""wget -O Mixz 'https://github.com/TheLastBen/fast-stable-diffusion/raw/main/Dreambooth/Regularization/Mix'""")
...
#   os.system("""python /content/diffusers/scripts/convert_original_stable_diffusion_to_diffusers.py --checkpoint_path "$MDLPTH" --dump_path "$OUTPUT_DIR" --session_dir "$SESSION_DIR"
...
#   print("Almost done ...")
#   os.chdir("""/content
#   os.system("""wget -O convertosd.py https://github.com/TheLastBen/fast-stable-diffusion/raw/main/Dreambooth/convertosd.py
#   clear_output()
#   if precision=="no":
#     os.system("""sed -i '226s@.*@@' /content/convertosd.py
#   os.system("""sed -i '201s@.*@    model_path = "{OUTPUT_DIR}"@' /content/convertosd.py
#   os.system("""sed -i '202s@.*@    checkpoint_path= "{SESSION_DIR}/{Session_Name}.ckpt"@' /content/convertosd.py
#   os.system("""python /content/convertosd.py
#   clear_output()
#   if os.path.exists(SESSION_DIR+"/"+INSTANCE_NAME+'.ckpt'):
#     if not os.path.exists(str(SESSION_DIR+'/tokenizer')):
#       os.system("""cp -R '/content/models/'$INSTANCE_NAME'/tokenizer' "$SESSION_DIR"
